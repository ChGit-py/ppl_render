                    ...
                    html.Div([
                        ...
                        dash_table.DataTable(
                            ...
                            columns=[
                                ...
                                {'name': 'Pos', 'id': 'position'},
                                {'name': 'Price', 'id': 'price', 'type': 'numeric', 'format': {'specifier': '.1f'}},
                                {'name': 'GW In', 'id': 'transfers_in_gw', 'type': 'numeric', 'format': {'specifier': ','}},
                                {'name': 'GW Out', 'id': 'transfers_out_gw', 'type': 'numeric', 'format': {'specifier': ','}},
                                {'name': 'Net', 'id': 'net_transfers_gw', 'type': 'numeric', 'format': {'specifier': ','}},
    ...
    try:
        ...
        return html.Div([
            html.Div([
                ...
                html.Pre(traceback.format_exc(), style={'fontSize': '12px', 'color': COLORS['text_light'], 'whiteSpace': 'pre-wrap'})
            ], style=CARD_STYLE)
        ])
